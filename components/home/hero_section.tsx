...
const HeroSection = () => {
  return (
    ...
    //         </div>
    //         <div className="space-y-2">
    //           <div className="text-2xl font-bold text-primary text-white">10M+</div>
    ...
    //   </div>
    // </section>
    <section className="relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-purple-950 via-indigo-950 to-indigo-950 py-24 md:py-32">
      {/* Gradient overlay */}
      <div className="absolute inset-0">
        <div className="absolute left-1/4 top-0 h-[500px] w-[500px] rounded-full bg-gradient-to-r from-violet-600/20 to-indigo-600/20 blur-3xl"></div>
      </div>

      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col-reverse items-center justify-center gap-16 md:flex-row">
        {/* Content */}
        <div className="flex-1 space-y-8 text-center md:text-left">
          <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl">
            Explore the World Through
          ...
          <p className="mx-auto max-w-2xl text-lg text-gray-300 md:text-xl md:mx-0">
            Discover insightful articles, thought-provoking stories, and expert
            perspectives on technology, lifestyle, and innovation.
          </p>
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-4 pt-8 text-white max-w-md mx-auto md:mx-0">
            <div className="space-y-2">
        ...
        <div className="flex-1 flex justify-center">
          <div className={cn("relative h-64 w-64 rounded-2xl overflow-hidden bg-gradient-to-br from-white/5 to-transparent border border-white/10 backdrop-blur-lg shadow-2xl shadow-indigo-500/10")}>
            {/* <Image
          src="https://images.unsplash.com/photo-1485988412941-77a35537dae4?q=80&w=2992&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="Illustration for the blog"
          fill
