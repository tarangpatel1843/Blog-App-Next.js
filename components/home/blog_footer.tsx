...
// <footer className="border-t border-muted bg-background text-foreground mr-0">
//   <div className=" mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
...
//           <li><a href="#" className="hover:text-foreground transition-colors">All Articles</a></li>
//           <li><a href="#" className="hover:text-foreground transition-colors">Topics</a></li>
//           <li><a href="#" className="hover:text-foreground transition-colors">Authors</a></li>
